        ...
        do {
            ...
            switch (choice) {
                ...
                case 3:
                    ...
                    do {
                        System.out.println("Enter which Entity you want to Delete");
                    ...
                    do {
                        ...
                        switch (choice4) {
                            ...
                            case 2:
                                ...
                                break;
                            case 3:
                                System.out.println("Retrieving Station Details ");
                                ...
                                break;
                            case 4:
                                System.out.println("Retrieving Reservation Details ");
                                reservationServices.retrieveReservation().forEach(reservation -> {
                                    System.out.println("Reservation Id: " + reservation.getReservationId() +
                                            ...
                                            " PNR No: " + reservation.getPnrNo() +
                                            " Journey Date: " + reservation.getJourneyDate());
                                });
                                break;
                            case 5:
                                System.out.println("Retrieving Payment Details ");
                                paymentDetailsServices.retrievePayment_Details().forEach(paymentDetails -> {
                                    System.out.println("Payment Id: " + paymentDetails.getPaymentId() +
                                            " Reservation Id: " + paymentDetails.getUserId() +
                                            " User Id: " + paymentDetails.getUserId() +
                                            " User Name: " + paymentDetails.getUserName() +
