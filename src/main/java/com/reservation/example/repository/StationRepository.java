...
public class StationRepository {
    ...
    public List<Station> retrieveStaion(){
        ...
        try {
            ...
            ResultSet resultSet=statement.executeQuery("Select * from Staion");
            ...
            while (resultSet.next()){
                ...
                Station station1=new Station(station_id,user_id);
    ...
    public boolean updateStaion(Station station)throws  SQLException{
        this.initConnection();
